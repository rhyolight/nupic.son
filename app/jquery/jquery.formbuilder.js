	...
	$.fn.formbuilder = function(options) {
		...
		return this.each(function() {
			...
			var checkboxFieldHtml = function(values){
				...
				field += '<a href="#" class="remove" title="Are you sure you want to remove this checkbox?">x</a>';
				field += '</div>';
			...
			var radioFieldHtml = function(values, name){
				...
				field += '<a href="#" class="remove" title="Are you sure you want to remove this radio button option?">x</a>';
				field += '</div>';
			...
			var appendFieldLi = function(title, field_html, required, help){
				...
				li += '<div class="frm-elements clearfix">';
				li += field;
				li += '<div class="frm-fld frm-help clearfix"><label for="help-'+last_id+'">Help Text:</label><input type="text" value="" name="required-'+last_id+'" id="help-'+last_id+'" class="help"></div>';
				li += '<div class="frm-fld frm-require clearfix"><label for="required-'+last_id+'">Required?</label><input class="required" type="checkbox" value="1" name="required-'+last_id+'" id="required-'+last_id+'"'+(required ? ' checked="checked"' : '')+' /></div>';
				li += '</div>';
