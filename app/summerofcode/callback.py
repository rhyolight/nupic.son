...
from summerofcode.views import notification_settings
...
class Callback(object):
  ...
  def registerViews(self):
    ...
    self.views.append(connection.LIST_CONNECTION_FOR_ORG_ADMIN)
    ...
    self.views.append(notification_settings.NOTIFICATIONS_SETTINGS_PAGE)
