...
DEF_NO_GCI_ORG_MEMBER_MSG = ugettext(
...
class AccessChecker(access_checker.AccessChecker):
  ...
  def canTakeOrgApp(self):
    """A user can take the GCI org app if he/she participated in GCI in a role
    other than student.
    """
    ...
    if not profile:
      raise AccessViolation(DEF_NO_GCI_ORG_MEMBER_MSG)
