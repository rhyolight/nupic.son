...
class GCIOrgAppPreviewPage(GCIRequestHandler):
  ...
  def context(self):
    form = gci_forms.OrgAppTakeForm(self.data)
...
class GCIOrgAppTakePage(GCIRequestHandler):
  ...
  def context(self):
    if self.data.org_app_record:
      form = gci_forms.OrgAppTakeForm(self.data, self.data.POST or None,
  ...
  def recordOrgAppFromForm(self):
    ...
    if self.data.org_app_record:
      form = gci_forms.OrgAppTakeForm(
          self.data, self.data.POST, instance=self.data.org_app_record)
    else:
      form = gci_forms.OrgAppTakeForm(self.data, self.data.POST)
