...
class SlotsTransferAdminPage(base.GSoCRequestHandler):
  ...
  def jsonContext(self):
    list_content = SlotsTransferAdminList(self.data.request, self.data).getListData()
  ...
  def post(self):
    slots_list = SlotsTransferAdminList(self.data.request, self.data)
  ...
  def context(self):
    return {
      ...
      'slot_transfer_list': SlotsTransferAdminList(self.data.request, self.data),
    }
