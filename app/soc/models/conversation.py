...
class Conversation(ndb.Model):
  ...
  last_message_on = ndb.DateTimeProperty(required=False,
  ...
  organization = ndb.KeyProperty(required=False,
  ...
  #: matching the criteria defined above.
  auto_update_users = ndb.BooleanProperty(required=True, default=True,
...
class ConversationUser(ndb.Model):
  ...
  last_message_seen_on = ndb.DateTimeProperty(required=False)

  #: Preference for receiving email notifications for new messages in a conversation
